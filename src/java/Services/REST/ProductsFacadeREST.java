...
public class ProductsFacadeREST extends AbstractFacade<Products> {
    ...
    public ArrayList<JSONObject> productsList() {
        ArrayList<JSONObject> aProducts = new <JSONObject>ArrayList();
        for (Products p : super.findAll()){
            JSONObject outputJsonObj = new JSONObject();
            outputJsonObj.put("name", p.getName());
            outputJsonObj.put("description",p.getDescription());
            outputJsonObj.put("price", p.getPrice());
            aProducts.add(outputJsonObj);
        }
        return aProducts;
    }
