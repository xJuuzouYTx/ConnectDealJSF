...
import com.conecctdeal.sessionbeans.ProductsFacade;
...
public class ProductsController implements Serializable {
    ...
    @EJB
    private com.conecctdeal.sessionbeans.ProductsFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/ConecctDeal").getString("ProductsCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/ConecctDeal").getString("ProductsUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/ConecctDeal").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/ConecctDeal").getString("ProductsDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/ConecctDeal").getString("PersistenceErrorOccured"));
        }
    }
